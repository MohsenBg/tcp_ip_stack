...
init_libcli() {
    ...
    init_param(&suboptions_param, CMD, SUBOPTIONS_CHARACTER, display_sub_options_callback, 0, INVALID, 0,
               "Sub-Options");
    init_param(&cmd_expansion_param, CMD, CMD_EXPANSION_CHARACTER, display_cmd_expansion_callback, 0, INVALID, 0,
...

    {
        ...
        libcli_register_param(&debug, &ut);
        {
            ...
            init_param(&enable, LEAF, 0, ut_test_handler, enable_disable_validation_handler, STRING, "ut-enable",
                       "enable | disable");
    ...
    init_param(&supportsave_enable, CMD, "enable", supportsave_handler, 0, INVALID, 0,
               "enable/disable Support Save Data Collection");
    ...
    init_param(&config_console_name_name, LEAF, 0, config_console_name_handler, 0, STRING, "cons-name",
               "Name of Console");
